...
describe('allowExistingPassphrase(config) sets a status when it has NEITHER password nor passphrase', ()=>{
...
describe('allowExistingPassphrase(config) sends a response when it has NEITHER password nor passphrase', ()=>{
    ...
    it(`in standard/standard locations, with a custom response string`, done=>{
        const allowExistingPassphrase = ValidateAuth({}).allowExistingPassphrase;
        const middleware = allowExistingPassphrase({haveNeitherMessage: 'custom response'});
        const req = {body: {password: null, passphrase: null}};
        const res = {
            status: ()=>{},
            send: (s)=>{
    ...
    it(`in standard/standard locations, with a custom response object`, done=>{
        const allowExistingPassphrase = ValidateAuth({}).allowExistingPassphrase;
        const middleware = allowExistingPassphrase({haveNeitherMessage: {en: 'english response'}});
        const req = {body: {password: null, passphrase: null}};
        const res = {
            status: ()=>{},
            json: (o)=>{
